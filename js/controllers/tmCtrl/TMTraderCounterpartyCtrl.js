...
define(['app'], function (app) {
  return app.controller('TMTraderCounterpartyCtrl', ['$scope', '$rootScope', 'serverService', '$cookies', '$timeout', 'baseService', function ($scope, $rootScope, serverService, $cookies, $timeout) {
    $rootScope.title = '交易管理';
    $rootScope.name = '交易对手维护'
    $rootScope.pageNow = 'tmTraderCounterparty';
    $rootScope.pageIndex = 1;
    $scope.tmFund = {};
    $rootScope.isPagination = true
    getTradeCounterparty(1, 17, 2);
    $scope.getTradeCounterparty = function (keyword) {
      getTradeCounterparty(1, 17, 2, keyword);
    }
