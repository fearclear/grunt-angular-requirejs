define(['app'], function (app) {
  return app.controller('TKBondDetailsCtrl', ['$scope', '$rootScope', 'serverService', '$cookies', 'baseService',
    function ($scope, $rootScope, serverService, $cookies) {
      $rootScope.pageNow = 'TKBondDetails';
      $rootScope.pageIndex = '1';
      $rootScope.title = '交易看板';
      $rootScope.name = '债券明细动态';
