    ...
    return {
        KEY: {
            API: {
                ...
                winUrl: 'http://192.168.0.151/windservice',
                // winUrl: 'http://192.168.1.30/windservice',
                wsUrl: 'ws://192.168.0.188:9333/basin/ws',
                // wsUrl: 'ws://192.168.1.188:9333/basin/ws',
                nbfUrl: 'http://192.168.0.221:8090',
                // nbfUrl: 'http://192.168.1.30:8091',
                wordUrl: 'http://192.168.0.221:8091',
                // wordUrl: 'http://192.168.1.30:8091',
                stateUrl: 'http://192.168.0.221:8090',
                // stateUrl: 'http://192.168.1.30:8092',
            },
            USERINFO: '__user-info__',
            COMPANYLIST: '__companyList__',
            STATISTICAL: {
                KEY: '__statistical-key__',
                DATA: '__statistical-data__',
                BASEDATE: '__statistical-base-date__',
                OTHERDATE: '__statistical-other-date__'
            },
            POSITIONMANAGEMENT: {
                KEY: '__positionManagement-key__',
                DATA: '__positionManagement-data__',
                PMDATE: '__positionManagement-date__',
                OVKEY: '__positionManagement-ovKey__',
                PMOVDATE: '__positionManagement-ovDate__',
                PMOVDATA: '__positionManagement-ovData__',
                PMOVFUND: '__positionManagement-ovFund__',
                PMCONTROLINDEXCTRLDATA: '__positionManagement-controlIndex-data__',
            },
            INITPARAMS: {
                BUSINESSTYPES: '__business-types__',
                FUNDNAMESFUND: '__fund-names-fund__',
                DIRECTIONS: '__directions__',
                LIQUIDATIONSPEEDS: '__liquidation-speeds__',
                BUSINESSSTATES: '__business-states__',
                COUNTERPARTYTYPES: '__counterparty-types__',
                COUNTERPARTIES: '__counterparties__',
                MARKETS: '__markets__',
                TRADERNAMES: '__trader-names__',
                SERVICETYPES: '__service-types__',
                FUNDNAMES: '__fund-names__',
                FUNDNAMESNORMAL: '__fund-names-normal',
                PAYTYPES: '__pay-types__',
                PROVINCES: '__provinces__',
                CLAIREEMINDUSTRYONES: '__claire-em-industry-ones__',
                CLAIREGRADES: '__claire-grades__',
                CLAIRESCORES: '__claire-scores__',
                NBACCOUNTS: '__nb-accounts__',
            },
            RISKMANAGEMENT:{
                FUNDIDS: '__rm-fundids__',
                WINDFUNDIDS: '__rm-wind-fundids__',
                FORMORDER: '__rm-form-order__',
            },
            NOTI: '__noti__',
        },
        session : {
